...
This overview intentionally does not decide technology beyond the Mobile Pilot 1 choices recorded in ADR-0008 through ADR-0011. Future synchronization engine or protocol, attachment-storage backend, identity/authentication implementation, server language, deployment packaging, final server-mode topology, and AI implementation remain undecided.
