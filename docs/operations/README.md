...
- [Backup, Restore, and Data Export Requirements](backup-restore-and-data-export-requirements.md): requirements for backup, restore, export, portability, and sensitive data handling.
- [Upgrades, Migrations, and Recovery Requirements](upgrades-migrations-and-recovery-requirements.md): upgrade safety, migration expectations, sync repair, and failure recovery requirements.
