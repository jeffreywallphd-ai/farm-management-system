...
The current accepted implementation target is a standalone mobile pilot. Server deployment modes remain future-facing unless later ADR/product work authorizes them.
