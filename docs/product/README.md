...
- [Farm Planning and Roadmapping](farm-planning-roadmapping.md): accepted local goals, subgoals, assignment-ready tasks, and work boards for farm planning and certification planning.
- [Farmhand Management](farmhand-management.md): accepted local farmhand directory, schedules, task assignment, and farmhand work-board behavior.
