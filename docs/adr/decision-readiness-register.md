...
| [ADR-0014](ADR-0014-organic-certification-readiness-module.md) | Organic certification readiness module | Product roadmap now authorizes full USDA organic readiness support | Add local evidence/reporting tools without certifier submission, cloud sync, or legal/certification determinations |
| [ADR-0015](ADR-0015-local-farm-planning-foundation.md) | Local farm planning foundation | Farmers need long-term planning, practical task chunking, and certification planning without a separate checklist subsystem | Add local goals, subgoals, assignment-ready tasks, task links, and optional local task instructions without sync, auth, notifications, or workflow-engine scope |
...
| Generalized workflow engine or premature microservices | Product non-goal / excluded from initial slice; local planning foundation accepted separately by ADR-0015 | [Initial Vertical Slice](../product/initial-vertical-slice.md), [ADR-0015](ADR-0015-local-farm-planning-foundation.md) |
