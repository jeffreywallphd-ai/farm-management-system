...
| [ADR-0015](ADR-0015-local-farm-planning-foundation.md) | Local farm planning foundation | Farmers need long-term planning, short-term task chunking, and certification planning without a separate checklist subsystem | Add local goals, subgoals, planning periods, tasks, and links without sync, auth, notifications, or workflow-engine scope |
