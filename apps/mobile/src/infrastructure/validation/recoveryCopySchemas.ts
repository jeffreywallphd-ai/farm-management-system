...
const organicReportPackageSchema = z.object({
  id: z.string().min(1),
  farmId: z.string().min(1),
  packageType: z.enum(["inspectionPrep", "annualUpdate", "recordsArchive"]),
  title: z.string().min(1),
...
const organicEvidenceLinkSchema = z.object({
  ...
  category: z.enum(["land", "inputs", "seeds", "soil", "pest", "traceability", "osp", "inspection", "advancedScope", "general"]),
