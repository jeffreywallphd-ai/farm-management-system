...
const inventoryItemSchema = z.object({
  ...
  commonItemKey: z.string().optional(),
  acquisitionSource: z.enum(["purchase", "donation", "selfProduced", "alreadyOwned"]),
  trackedItemId: z.string().optional(),
  ...
  notes: z.string().optional(),
  purchaseNoteFarmEventId: z.string().optional(),
  organicRelevance: z.enum([
    "none",
    "cropProductionInput",
    "soilAmendment",
    "pestControlInput",
  ...
  organicRegulationNotes: z.string().optional(),
  organicEvidenceNotes: z.string().optional(),
  equipmentContactRisk: z.string().optional(),
  cleaningRequired: z.boolean(),
  lastCleanedAt: isoDateTimeString.optional(),
  createdAt: isoDateTimeString,
  updatedAt: isoDateTimeString,
});
